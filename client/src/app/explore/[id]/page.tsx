...
const ProfilePage: React.FC = () => {
  ...
  const getTransformedPools = () => {
    const transformedPools =  totalPools?.length && totalPools?.map((pool) => ({
      id: pool?.poolId,
      imageUrl: "https://www.rollingstone.com/wp-content/uploads/2024/03/GettyImages-2074745918-1.jpg?w=1581&h=1054&crop=1",
  ...
  return (
    <section className="container mx-auto px-4 py-12 mt-24">
      ...
      {/* Tab Content */}
      {activeTab === "pools" && <PostsGrid posts={transfomedPoolsData} />}
